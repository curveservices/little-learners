          ...
          <section className="fith-section">
            ...
            <div className="unordered-list">
              ...
              <ul>
                <li>Maths Games</li>
                <li>
                  Activities to extend children's learning about understanding
                  the world and personal, social &amp; emotional development,
                  learning to take in turns.
                </li>
            ...
            <div className="timetable">
              ...
              <div className="afternoon">
                <ul>
                  ...
                  <li>
                    <b>2:00pm - 3:00pm</b> Art Club, Board Games Club, Early
                    Years Writing Club or Early Years Maths Club
                  </li>
                  <li>
