      ...
      <section className="hero">
        <div className="text-box">
          ...
          <p>
            ...
            foundation of understanding, skills and knowledge in three prime and
        ...
        <div className="timetable">
          <div className="morning">
            <ul>
              ...
              <li>
                <b>9:00am - 10:15am</b> Key activities in small groups/ outdoor
                time, daily PE
              </li>
              <li>
              ...
              <li>
                <b>11.00am - 11.45am</b> Free play, small group child-led daily
                activities/key worker activities
              </li>
              <li>
                <b>12.35pm - 12.40pm</b> Tidy up time
              </li>
              <li>
                <b>12.40pm -12.55pm</b> Carpet time, one of the following: Yoga
                and movement, Sign Language, Maths, Phonics or Music
              </li>
              <li>
