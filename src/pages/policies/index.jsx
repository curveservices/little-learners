    ...
    <>
      <Helmet
        ...
        schemaMarkup={{
          ...
          url: "https://www.littlelearnerspreschool.uk/policies-and-procedures",
        }}
      />
      <div className="policy-page">
        <img
          ...
          src={background}
          alt="Little Learners Policies, Blackheath, London"
        />
          ...
          <section className="second-section">
            ...
            <div className="document-list">
              ...
              <ul>
                ...
                <li>
                  <a
                    href="/Allergies_and_food_intolerance.docx"
                    download={true}
                  >
                ...
                <li>
                  <a
                    ...
                    download={true}
                  >
                    Low level concerns allegations of harm or abuse against
                    staff
                  </a>
                </li>
                <li>
